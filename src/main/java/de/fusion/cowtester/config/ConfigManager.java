package de.fusion.cowtester.config;


import de.fusion.cowtester.CowTester;
import de.fusion.cowtester.common.config.ConfigAdapter;
import de.fusion.cowtester.common.config.ConfigAdapterInterface;
import de.fusion.cowtester.common.config.ConfigReader;
import de.fusion.cowtester.common.config.ConfigWriter;
import java.io.File;
...
public class ConfigManager extends ConfigAdapter implements ConfigAdapterInterface {
  ...
  private class RealConfigWriter implements ConfigWriter {
    ...
    public void setAsyncObject(Object o) {
      CowTester.getMainExecutorService().submit(() -> this.setObject(o));
    }
  }
}
